// problem link
// https://codeforces.com/gym/564136/problem/I
/*
*
*
#									{	 I have no choice		}
...
{
	short age; cin >> age;
	if (age < 0 || age>120)C << "Invalid age" << E;
	else if (age <= 12)C << "Child" << E;
	else if (age <= 19)C << "Teenager" << E;
	else if (age <= 64)C << "Adult" << E;
	else if (age >=65)C << "Senior" << E;
